...
export const tianwenData: Verse[] = [
  // 第一部分：宇宙起源 - 天地开辟与宇宙生成
  {
    ...
    analysis: {
      ...
      sentenceAnalysis: "屈原开篇即问：在那遥远的古代，天地初开的时候，是谁把这开天辟地的消息传述下来的呢？这是对宇宙起源知识来源的根本质疑，体现了屈原理性思辨的精神。"
    }
  },
  {
    id: 2,
    ...
    analysis: {
      ...
      sentenceAnalysis: "当天地还没有成形，宇宙还处于混沌状态的时候，又能根据什么来考证验证呢？这进一步质疑了关于宇宙起源知识的可靠性，反映了屈原对传统创世神话的理性反思。"
    }
  },
  {
    id: 3,
    ...
    analysis: {
      ...
      sentenceAnalysis: "宇宙在明暗交替、一片昏暗混沌之中，谁能够彻底探究其中的奥秘呢？这里描绘了原始宇宙的混沌景象，同时表达了对探索宇宙奥秘之难的感慨。"
    }
  },
  {
    id: 4,
    ...
    analysis: {
      ...
      sentenceAnalysis: "仅仅凭借表面的现象和形象，凭什么能够真正认识和了解宇宙的本质呢？屈原这里强调了现象与本质的区别，体现了朴素的认识论思想。"
    }
  },
  {
    id: 5,
    ...
    analysis: {
      ...
      sentenceAnalysis: "明明暗暗的反复变化，在天地初开的时候是为了什么目的呢？这是对宇宙运行规律目的性的追问，体现了屈原对天道运行深层原因的思考。"
    }
  },
  {
    id: 6,
    ...
    analysis: {
      ...
      sentenceAnalysis: "阴阳二气和天地人三才相合，什么是根本什么是变化？这涉及中国古代哲学中阴阳学说和三才思想，屈原在探讨宇宙生成的根本动力和变化规律。"
    }
  },
  ...
  },
  {
    ...
    analysis: {
      ...
      sentenceAnalysis: "这九重天是何等伟大的功绩，是谁最初创造的呢？这是对宇宙创造者的赞叹和追问，体现了古人面对宇宙奇观时的敬畏之情。"
    }
  },
  {
    id: 9,
  ...
  },
  {
    ...
    analysis: {
      ...
      sentenceAnalysis: "九重天的边际，在哪里放置又在哪里相互连接？这是对天体结构边界和层次关系的追问，体现了古人对宇宙空间结构的思考。"
    }
  },
  {
    id: 12,
    ...
    analysis: {
      ...
      sentenceAnalysis: "天空的角落隐蔽处有很多，谁知道它们的确切数目？这表现了古人面对浩瀚宇宙时的困惑，认识到宇宙的复杂性超出了人类的认知能力。"
    }
  },
  ...
  // 第三部分：远古神话 - 创世传说与神话人物
  {
    ...
    analysis: {
      ...
      sentenceAnalysis: "天空在什么地方重叠？十二个时辰是怎么分开的？这涉及古代的时间观念，十二时辰制是中国古代重要的时间计量方法，屈原在此追问时间划分的原理。"
    }
  },
  {
    id: 14,
    ...
    analysis: {
      ...
      sentenceAnalysis: "日月依附在哪里？众星又是怎样排列陈设的？这是对天体运行和星座分布的疑问，反映了古人对天文现象的观察和思考。"
    }
  },
  {
    id: 15,
    ...
    analysis: {
      ...
      sentenceAnalysis: "太阳从东方的汤谷升起，在西方的蒙汜落下。汤谷和蒙汜都是中国古代神话中的地名，汤谷又称扶桑，是十个太阳居住的地方；蒙汜是太阳落山之处。这反映了古人对日出日落现象的神话化解释。"
    }
  },
  {
    id: 16,
    ...
    analysis: {
      ...
      sentenceAnalysis: "从天明到天黑，太阳总共走了多少里路？这是对太阳日行距离的追问，体现了古人试图用具体的数字来量化天体运动的朴素科学精神。"
    }
  },
  {
    id: 17,
    ...
    analysis: {
      ...
      sentenceAnalysis: "月亮有什么德行，能够消失后又重新生长出来？这是对月相变化规律的疑问，古人观察到月亮有圆缺变化，用'死而复生'来形容这种现象，体现了对自然规律的朴素认识。"
    }
  },
  {
    id: 18,
  ...
  },
  {
    ...
    analysis: {
      ...
      sentenceAnalysis: "女歧没有配偶，怎么能生下九个儿子？这涉及古代神话中神灵的生殖能力，体现了对神话中超自然生育现象的理性质疑。"
    }
  },
  {
    id: 20,
  ...
  },
  {
    ...
    analysis: {
      ...
      sentenceAnalysis: "角宿还没有出现、天还没亮的时候，太阳在哪里隐藏？二十八宿是中国古代重要的星座系统，角宿的出现标志着天明，这里询问太阳夜间的去处。"
    }
  },
  {
    id: 23,
  ...
  },
  {
    ...
    analysis: {
      ...
      sentenceAnalysis: "大家都说有什么好担忧的，为什么不经过考核试验就实行治水方案呢？这反映了对鲧治水方案缺乏科学论证的批评。"
    }
  },
  {
    id: 25,
  ...
  },
  {
    ...
    analysis: {
      ...
      sentenceAnalysis: "鲧顺从民意想要完成治水大业，上帝为什么要惩罚他？这体现了对鲧被杀的不平，认为鲧出于好意却遭到惩罚是不公正的。"
    }
  },
  {
    id: 27,
    ...
    analysis: {
      ...
      sentenceAnalysis: "鲧长久被困死在羽山，为什么三年时间尸体都不腐烂？这涉及鲧死后尸体不腐的神话传说，体现了古人对英雄人物的神化。"
    }
  },
  {
    id: 28,
    ...
    analysis: {
      ...
      sentenceAnalysis: "大禹从鲧的腹中诞生，凭借什么能够如此神奇地变化？传说鲧死后三年尸体不腐，后来用吴刀剖开，大禹从中跳出，这是古代神话中常见的神奇诞生模式。"
    }
  },
  {
    id: 29,
    ...
    analysis: {
      ...
      sentenceAnalysis: "大禹继承并完成了父亲未竟的事业，终于完成了治水这一伟大功绩。这里赞扬了大禹继承父志、完成治水大业的精神。"
    }
  },
  {
    id: 30,
    ...
    analysis: {
      ...
      sentenceAnalysis: "为什么同样是继续最初的治水事业，但大禹的方法谋略却与鲧不同？这指出了鲧用堵、禹用疏的不同治水策略，体现了方法的重要性。"
    }
  },
  ...
  // 第五部分：夏商兴替 - 夏桀暴政与商汤革命
  {
    ...
    analysis: {
      ...
      sentenceAnalysis: "洪水的源泉非常深，用什么方法来填塞它？这延续了对治水问题的思考，质疑用填塞方法治理深水的可行性。"
    }
  },
  {
    id: 32,
    ...
    analysis: {
      ...
      sentenceAnalysis: "大地分为九州，用什么方法使它们高起来？九州是古代中国的基本地理概念，这里询问地形形成的原因。"
    }
  },
  {
    id: 33,
  ...
  },
  {
    ...
    analysis: {
      ...
      sentenceAnalysis: "鲧营造了什么工程，大禹成就了什么功业？这是对父子两代治水成果的对比询问。"
    }
  },
  {
    id: 35,
  ...
  },
  {
    ...
    analysis: {
      ...
      sentenceAnalysis: "九州是怎么安排分布的？江河山谷为什么会深陷成低洼地带？这继续探讨地理格局形成的原因。"
    }
  },
  {
    id: 37,
    ...
    analysis: {
      ...
      sentenceAnalysis: "江河向东流淌而不溢出河道，谁知道其中的原因？这是对河流规律性流向的疑问，体现了对自然规律的思考。"
    }
  },
  {
    id: 38,
    ...
    analysis: {
      ...
      sentenceAnalysis: "东西南北四个方向，它们的距离长度哪个更长？这是对地球大小和形状的朴素探索。"
    }
  },
  {
    id: 39,
    ...
    analysis: {
      ...
      sentenceAnalysis: "南北方向顺着椭圆形，它延伸的距离有多少？这显示了古人对地球可能不是完全圆形的朴素认识。"
    }
  },
  {
    id: 40,
  ...
  },
  {
    ...
    analysis: {
      ...
      sentenceAnalysis: "四方的门户，是谁从那里经过呢？这可能指天门或神仙出入的门户。"
    }
  },
  {
    id: 43,
    ...
    analysis: {
      ...
      sentenceAnalysis: "西北方向开辟启动，什么气息从那里通过？这可能与古代关于西北方不周山的神话有关。"
    }
  },
  {
    id: 44,
  ...
  },
  {
    ...
    analysis: {
      ...
      sentenceAnalysis: "什么地方冬天温暖，什么地方夏天寒冷？这是对气候反常现象的疑问，体现了古人对不同地区气候差异的观察。"
    }
  },
  {
    id: 47,
    ...
    analysis: {
      ...
      sentenceAnalysis: "哪里有石头组成的森林，什么野兽能够说话？这涉及古代神话传说中的奇异景观和神兽。"
    }
  },
  {
    id: 48,
    ...
    analysis: {
      ...
      sentenceAnalysis: "哪里有无角龙，背负着熊来遨游？这描绘了神话中奇异的景象，体现了古人丰富的想象力。"
    }
  },
  {
    id: 49,
  ...
  // 第七部分：春秋乱世 - 诸侯争霸与政治变迁
  {
    ...
    analysis: {
      ...
      sentenceAnalysis: "靡蓱草生长在四通八达的道路上，麻花在哪里安身生长？这是对植物生长环境的观察和疑问。"
    }
  },
  {
    id: 52,
    ...
    analysis: {
      ...
      sentenceAnalysis: "一条蛇能吞下大象，它的大小该是怎样的呢？这可能出自'人心不足蛇吞象'的典故，体现了对贪欲无度的思考。"
    }
  },
  {
    id: 53,
    ...
    analysis: {
      ...
      sentenceAnalysis: "黑水河和玄趾族，三危山在哪里？这涉及古代的地理知识和民族分布。"
    }
  },
  {
    id: 54,
    ...
    analysis: {
      ...
      sentenceAnalysis: "如果能延年益寿长生不老，寿命在什么地方停止终结？这是对生命极限的哲学思考。"
    }
  },
  {
    id: 55,
    ...
    analysis: {
      ...
      sentenceAnalysis: "神鱼鲮鱼在什么地方，怪物鬿堆又在哪里居住？这涉及古代神话中的神兽怪物。"
    }
  },
  {
    id: 56,
  ...
  },
  {
    ...
    analysis: {
      ...
      sentenceAnalysis: "大禹用他的力量奉献功劳，下到大地四面八方视察。这赞颂了大禹治水时亲历实地、深入各方的精神。"
    }
  },
  {
    id: 58,
    ...
    analysis: {
      ...
      sentenceAnalysis: "怎么得到那座嵞山，然后在九个太阳之间畅通迅速地穿行？这可能与后羿射日的神话相关。"
    }
  },
  {
    id: 59,
    ...
    analysis: {
      ...
      sentenceAnalysis: "不能胜任治理洪水的重任，民众为什么还要推崇他？这重复了前面对鲧的质疑，强调了能力与声望不符的问题。"
    }
  },
  {
    id: 60,
    ...
    analysis: {
      ...
      sentenceAnalysis: "众人都说有什么好担忧的，为什么不经过考核试验就实行？这再次强调了决策应该经过科学论证的重要性。"
    }
  },
  ...
  // 第八部分：哲理思辨 - 终极追问与人生思考
  {
    ...
    analysis: {
      ...
      sentenceAnalysis: "白色彩虹围绕缠绕，为什么形成这座殿堂？这可能描述天空中云霞变幻如宫殿的奇景。"
    }
  },
  {
    id: 62,
    ...
    analysis: {
      ...
      sentenceAnalysis: "怎么得到那些良药，却不能长久保存？这可能是对长生不老药的疑问，反映了古人对生命有限性的思考。"
    }
  },
  {
    id: 63,
    ...
    analysis: {
      ...
      sentenceAnalysis: "天的法则变化无常，太阳离去于是带来死亡。这体现了对天道无常和生死轮回的思考。"
    }
  },
  {
    id: 64,
    ...
    analysis: {
      ...
      sentenceAnalysis: "大鸟为什么鸣叫，怎么会失去它的身体？这可能涉及某种神鸟的传说或生死变化的寓意。"
    }
  },
  {
    id: 65,
    ...
    analysis: {
      ...
      sentenceAnalysis: "浮萍呼号能引起下雨，用什么方法兴起这种现象？这体现了古人对植物与天气关系的观察和思考。"
    }
  },
  {
    id: 66,
    ...
    analysis: {
      ...
      sentenceAnalysis: "聚集身体威胁鹿群，用什么来应对承受这种情况？这可能涉及狩猎或动物行为的观察。"
    }
  },
  {
    id: 67,
  ...
  },
  {
    ...
    analysis: {
      ...
      sentenceAnalysis: "放下船只登山行走，往哪里迁移？这可能描述某种特殊的旅行或迁徙方式。"
    }
  },
  {
    id: 69,
    ...
    analysis: {
      ...
      sentenceAnalysis: "只有浇在门户前，对嫂嫂有什么要求？浇是古代传说中羿的弟子，后来杀死了羿，这里可能涉及相关的故事情节。"
    }
  },
  {
    id: 70,
    ...
    analysis: {
      ...
      sentenceAnalysis: "为什么少康追逐狗，却使自己的头颠倒坠落？少康是夏朝的中兴之主，这里可能涉及某个具体的历史传说。"
    }
  },

  {
    ...
    analysis: {
      ...
      sentenceAnalysis: "女歧缝制衣服，然后与人住在一起于是停止。这涉及古代神话中女神的日常活动。"
    }
  },
  {
    id: 72,
    ...
    analysis: {
      ...
      sentenceAnalysis: "为什么颠倒交换他的头，却亲自因此遇到灾祸？这可能涉及某种神话传说中的变身或惩罚。"
    }
  },
  {
    id: 73,
    ...
    analysis: {
      ...
      sentenceAnalysis: "商汤谋划改革军队，用什么方法优待他们？这涉及商汤建国时的军事改革和治军策略。"
    }
  },
  {
    id: 74,
    ...
    analysis: {
      ...
      sentenceAnalysis: "翻覆船只攻打斟寻国，用什么方法攻取它？斟寻是夏代的重要诸侯国，这里涉及古代战争史。"
    }
  },
  {
    id: 75,
    ...
    analysis: {
      ...
      sentenceAnalysis: "夏桀攻打蒙山，得到了什么呢？这反映了对暴君穷兵黩武、劳民伤财行为的质疑。"
    }
  },
  {
    id: 76,
  ...
  },
  {
    ...
    analysis: {
      ...
      sentenceAnalysis: "舜在家中忧虑，父亲为什么成为鳏夫？这涉及舜的家庭背景，舜的生母早死，父亲瞽叟续娶，家庭关系复杂。"
    }
  },
  {
    id: 78,
    ...
    analysis: {
      ...
      sentenceAnalysis: "尧帝不通过姚姓家族告知，两个女儿怎么与舜亲近？这涉及尧将两个女儿嫁给舜的历史传说。"
    }
  },
  {
    id: 79,
    ...
    analysis: {
      ...
      sentenceAnalysis: "他的想法在开始萌芽时，有什么意图呢？这是对动机和初心的追问。"
    }
  },
  {
    id: 80,
    ...
    analysis: {
      ...
      sentenceAnalysis: "玉台有十层，是谁把它建造到如此极致？这可能指某种宏伟的建筑工程。"
    }
  },

  {
    ...
    analysis: {
      ...
      sentenceAnalysis: "登上王位成为帝王，是谁说要推崇他？这是对帝王权力合法性来源的质疑。"
    }
  },
  {
    id: 82,
    ...
    analysis: {
      ...
      sentenceAnalysis: "女娲有身体形态，是谁制作了她？女娲是中国古代神话中的重要创世神，据说她抟土造人、炼石补天，这里追问创世神本身的来源。"
    }
  },
  {
    id: 83,
    ...
    analysis: {
      ...
      sentenceAnalysis: "舜使他的弟弟象服从，最终却成为祸害。象是舜的异母弟，品行不端，多次谋害舜，这里反思了宽容的局限性。"
    }
  },
  {
    id: 84,
    ...
    analysis: {
      ...
      sentenceAnalysis: "为什么放纵品德低劣的人，而他自己却不遭受危险和失败？这是对纵容恶人而自身安然的不解。"
    }
  },
  {
    id: 85,
    ...
    analysis: {
      ...
      sentenceAnalysis: "吴获直到古代，都在南方的山岳停止居住。这涉及古代某个人物的地理活动。"
    }
  },
  {
    id: 86,
    ...
    analysis: {
      ...
      sentenceAnalysis: "谁期待离开这里，得到两个男子？这可能涉及某个具体的历史或神话情节。"
    }
  },
  {
    id: 87,
    ...
    analysis: {
      ...
      sentenceAnalysis: "沿着天鹅的形状装饰玉器，后来的帝王就这样享用。这描述了古代奢华的工艺品和帝王的享乐。"
    }
  },
  {
    id: 88,
    ...
    analysis: {
      ...
      sentenceAnalysis: "为什么承接夏桀的谋略，最终因此而灭亡丧失？这是对继承暴政恶果的反思。"
    }
  },
  {
    id: 89,
  ...
  },
  {
    ...
    analysis: {
      ...
      sentenceAnalysis: "为什么有条理地放逐和施加惩罚，百姓却服从并且非常高兴？这可能指推翻暴政后人民的拥护。"
    }
  },
  ...
  },
  {
    ...
    analysis: {
      ...
      sentenceAnalysis: "玄鸟带来赠送的蛋，你有什么好处？这涉及'天命玄鸟，降而生商'的神话，玄鸟下蛋，简狄吞食后生下契。"
    }
  },
  {
    id: 93,
    ...
    analysis: {
      ...
      sentenceAnalysis: "应该持有顺应季节的德行，他的父亲就是这样好。这体现了古代天人合一的思想，强调要顺应自然规律。"
    }
  },
  {
    id: 94,
    ...
    analysis: {
      ...
      sentenceAnalysis: "为什么最终在有扈氏那里困乏疲惫，像牧人一样放牧牛羊？有扈氏是古代反对大禹的部族，这里可能涉及相关的历史传说。"
    }
  },
  {
    id: 95,
    ...
    analysis: {
      ...
      sentenceAnalysis: "盾牌配合着按时节跳舞，用什么来怀念它？这可能指古代的祭祀舞蹈或军事演练。"
    }
  },
  {
    id: 96,
    ...
    analysis: {
      ...
      sentenceAnalysis: "平坦的肋部和美丽细腻的肌肤，用什么方法来滋养它？这可能是对美貌或健康的追问。"
    }
  },
  {
    id: 97,
    ...
    analysis: {
      ...
      sentenceAnalysis: "有扈氏的牧童，为什么就遇到了？这可能涉及某个具体的历史事件或传说。"
    }
  },
  {
    id: 98,
    ...
    analysis: {
      ...
      sentenceAnalysis: "敲击床榻后先出来，他的命令从哪里来？这可能涉及某种仪式或紧急情况。"
    }
  },
  {
    id: 99,
    ...
    analysis: {
      ...
      sentenceAnalysis: "常常持有顺应季节的德行，怎么得到那头纯朴的牛？这可能与古代祭祀用的牲畜有关。"
    }
  },
  {
    id: 100,
    ...
    analysis: {
      ...
      sentenceAnalysis: "到哪里去谋求分配俸禄，不只是为了回来？这可能涉及古代的官员任职和俸禄制度。"
    }
  },

  {
    ...
    analysis: {
      ...
      sentenceAnalysis: "在昏暗微弱中遵循足迹跟随，狄族因此不得安宁。这可能反映古代民族之间的冲突和迁徙。"
    }
  },
  {
    id: 102,
    ...
    analysis: {
      ...
      sentenceAnalysis: "为什么众多鸟类聚集在荆棘中，背着幼鸟放纵情感？这可能是对鸟类行为的观察，也可能有比喻意义。"
    }
  },
  {
    id: 103,
    ...
    analysis: {
      ...
      sentenceAnalysis: "迷惑的弟弟一起放纵邪恶，危害他的哥哥。这可能继续涉及舜和象的故事，或其他兄弟反目的历史典故。"
    }
  },
  {
    id: 104,
    ...
    analysis: {
      ...
      sentenceAnalysis: "为什么通过变化来制造欺诈，后代子孙却能遇到长久的兴盛？这是对因果报应的质疑。"
    }
  },
  {
    id: 105,
    ...
    analysis: {
      ...
      sentenceAnalysis: "成汤向东巡视，有莘氏于是达到了极盛。有莘氏是商汤妻子的娘家，这里可能指联姻带来的政治利益。"
    }
  },
  {
    id: 106,
    ...
    analysis: {
      ...
      sentenceAnalysis: "为什么向那个地位低微的臣子求取，却能这样得到贤良的妃子？这可能涉及商汤求贤或联姻的故事。"
    }
  },
  {
    id: 107,
    ...
    analysis: {
      ...
      sentenceAnalysis: "商汤出身于重泉，那有什么罪过呢？这可能是为商汤的出身或某些行为进行辩护。"
    }
  },
  {
    id: 108,
    ...
    analysis: {
      ...
      sentenceAnalysis: "内心不能胜任讨伐帝王的重任，那是谁使得别人挑拨他呢？这可能涉及推翻夏桀的动机和过程。"
    }
  },
  {
    id: 109,
    ...
    analysis: {
      ...
      sentenceAnalysis: "会盟朝见时争夺盟主地位，为什么要履行我的期约承诺？这涉及古代诸侯会盟的政治斗争。"
    }
  },
  {
    id: 110,
    ...
    analysis: {
      ...
      sentenceAnalysis: "苍鸟成群飞行，是谁使得它们聚集在一起？这可能是对自然现象的观察，也可能有政治寓意。"
    }
  },

  {
    ...
    analysis: {
      ...
      sentenceAnalysis: "大家一起攻击纣王本人，周公旦不赞成这样做。这涉及推翻商纣的历史，周公可能主张更温和的方式。"
    }
  },
  {
    id: 112,
    ...
    analysis: {
      ...
      sentenceAnalysis: "为什么要亲自度量后才起步，对周朝的命运因此感叹？这可能涉及周朝建立过程中的谨慎态度。"
    }
  },
  {
    id: 113,
    ...
    analysis: {
      ...
      sentenceAnalysis: "把天下统治权授予殷商，它的根基在哪里设置？这是对政权合法性和根基的追问。"
    }
  },
  {
    id: 114,
    ...
    analysis: {
      ...
      sentenceAnalysis: "反而因为成功就走向灭亡，它的罪过究竟是什么？这是对成功与失败辩证关系的思考。"
    }
  },
  {
    id: 115,
    ...
    analysis: {
      ...
      sentenceAnalysis: "争夺和派遣武器装备，用什么方法来实行这件事？这涉及军事行动的组织和实施。"
    }
  },
  {
    id: 116,
    ...
    analysis: {
      ...
      sentenceAnalysis: "并排驱赶攻击敌军两翼，用什么方法来带领指挥这些部队？这涉及古代军事战术。"
    }
  },
  {
    id: 117,
    ...
    analysis: {
      ...
      sentenceAnalysis: "周昭王之后完成了游历，南方的土地于是都到达了。这涉及周朝向南扩张的历史。"
    }
  },
  {
    id: 118,
    ...
    analysis: {
      ...
      sentenceAnalysis: "它的好处利益是什么，遇到那只白色野鸡？白雉在古代被视为祥瑞，这里可能涉及某种政治象征。"
    }
  },
  {
    id: 119,
    ...
    analysis: {
      ...
      sentenceAnalysis: "周穆王才能巧妙如梅花，那为什么要周游四方流转不定？穆王以好游著称，这里质疑其游历的意义。"
    }
  },
  {
    id: 120,
    ...
    analysis: {
      ...
      sentenceAnalysis: "环绕治理天下，那要寻求追求什么呢？这是对统治者终极目标的追问。"
    }
  },

  {
    ...
    analysis: {
      ...
      sentenceAnalysis: "妖异的人拖拽着东西炫耀，为什么在市场上呼号？这可能描述某种街头表演或奇异现象。"
    }
  },
  {
    id: 122,
    ...
    analysis: {
      ...
      sentenceAnalysis: "周幽王已经沉醉其中，褒姒有什么罪过呢？褒姒是历史上著名的美女，传说因她而引发烽火戏诸侯，导致西周灭亡。这里为褒姒辩护。"
    }
  },
  {
    id: 123,
    ...
    analysis: {
      ...
      sentenceAnalysis: "天命反复无常，惩罚什么又保佑什么？这是对天道公正性的质疑，体现了屈原对命运无常的困惑。"
    }
  },
  {
    id: 124,
    ...
    analysis: {
      ...
      sentenceAnalysis: "齐桓公九次会盟诸侯成为霸主，为什么突然被杀害？齐桓公晚年昏庸，最终被权臣所杀，这里感叹英雄末路的悲剧。"
    }
  },
  {
    id: 125,
    ...
    analysis: {
      ...
      sentenceAnalysis: "那个纣王本人，是谁使得他混乱迷惑？这是对纣王堕落原因的追问，暗示可能有外在因素。"
    }
  },
  {
    id: 126,
    ...
    analysis: {
      ...
      sentenceAnalysis: "为什么憎恶辅佐的忠臣，让谗言谄媚深入肌理？这批评了统治者疏远忠臣、亲近奸佞的行为。"
    }
  },
  {
    id: 127,
    ...
    analysis: {
      ...
      sentenceAnalysis: "比干有什么违逆之处，却被压制杀害？比干是历史上著名的忠臣，因直谏而被纣王剖心而死，这里为忠臣鸣不平。"
    }
  },
  {
    id: 128,
    ...
    analysis: {
      ...
      sentenceAnalysis: "雷开有什么顺从之处，却被赐予封爵？这与比干形成对比，批评了奖惩颠倒的现象。"
    }
  },
  {
    id: 129,
    ...
    analysis: {
      ...
      sentenceAnalysis: "为什么圣人的德行，最终会走向不同的方向？这是对圣人也会有不同结局的思考。"
    }
  },
  {
    id: 130,
    ...
    analysis: {
      ...
      sentenceAnalysis: "梅伯被做成肉酱惨死，箕子装疯来保全自己。这对比了两种不同的应对暴政的方式：直面死亡与韬光养晦。"
    }
  },
  ...
  // 最后部分
  {
    ...
    analysis: {
      ...
      sentenceAnalysis: "后稷是上帝的长子，上帝为什么要厚待他？后稷是中国农业之神，传说教民稼穑，这里追问神灵间的亲疏关系。"
    }
  },
  {
    id: 132,
    ...
    analysis: {
      ...
      sentenceAnalysis: "把后稷投放在冰面上，鸟儿为什么要温暖他？这涉及后稷出生的神话传说，据说他被遗弃后得到鸟兽保护。"
    }
  },
  {
    id: 133,
    ...
    analysis: {
      ...
      sentenceAnalysis: "为什么拿着弓箭夹着箭矢，就特别能够带领指挥？这可能涉及某位英雄的军事才能。"
    }
  },
  {
    id: 134,
    ...
    analysis: {
      ...
      sentenceAnalysis: "已经惊动了上帝使其急切激动，为什么还能遇到长久的好运？这是对因果关系的疑问。"
    }
  },
  {
    id: 135,
    ...
    analysis: {
      ...
      sentenceAnalysis: "周文王被称为衰微，却拿着权力之鞭担任诸侯之长。这里可能指文王韬光养晦的策略。"
    }
  },
  {
    id: 136,
    ...
    analysis: {
      ...
      sentenceAnalysis: "为什么命令撤除岐山的社稷，又命令拥有殷商的国土？这涉及周朝取代商朝的政治变革。"
    }
  },
  {
    id: 137,
    ...
    analysis: {
      ...
      sentenceAnalysis: "迁移财富宝藏到岐山，能够依靠什么？这可能涉及周朝建都前的准备工作。"
    }
  },
  {
    id: 138,
    ...
    analysis: {
      ...
      sentenceAnalysis: "殷商有迷惑人的妇女妲己，有什么可以讥讽批评的？这里可能为妲己辩护，认为不应该全部责怪女性。"
    }
  },
  {
    id: 139,
    ...
    analysis: {
      ...
      sentenceAnalysis: "接受了儿子被做成肉酱的赏赐，西伯侯向上天告发。这涉及文王之子伯邑考被纣王杀害做成肉酱的悲剧。"
    }
  },
  {
    id: 140,
    ...
    analysis: {
      ...
      sentenceAnalysis: "为什么亲近接近上帝，他的德行没有极限？这里赞颂某位圣王德行无边。"
    }
  },
  {
    id: 141,
    ...
    analysis: {
      ...
      sentenceAnalysis: "皇天聚集天命，只有什么能够警戒这件事？这是对天命权威性的最后追问。"
    }
  },
  {
    id: 142,
    ...
    analysis: {
      ...
      sentenceAnalysis: "接受了统治天下的礼制，又是什么使得别人来代替它？这是《天问》的最后一问，追问政权更替的永恒规律，体现了屈原对历史兴衰的深刻思考。"
    }
  }
];
